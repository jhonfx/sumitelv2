...
<html>
    ...
    <body>
        ...
        <div id="show-articulo" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.articulo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.articulo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
